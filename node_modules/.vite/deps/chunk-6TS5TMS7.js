...
var InputLabel = React27.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(InputLabelRoot, {
    "data-shrink": shrink,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var OutlinedInput = React34.forwardRef(function OutlinedInput2(inProps, ref) {
  var _React$Fragment;
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  ...
  return (0, import_jsx_runtime23.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime23.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime23.jsxs)(React34.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
//# sourceMappingURL=chunk-6TS5TMS7.js.map
